...
class SlaNotificationController extends Controller
{
    /**
     * Return all currently overdue (SLA-breached) tickets for the
     * authenticated user. Agents/admins see every overdue ticket;
     * regular users see only their own.
     *
     * Called by the front-end every 60 seconds via fetch().
     */
